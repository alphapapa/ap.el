;;; unpackaged-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Move filter group at point down." t)
(autoload 'unpackaged/ibuffer-filter-group-move-up "unpackaged" "\
Move filter group at point up." t)
...
Toggle overlay of current item in agenda." t)
...
(fn &optional (PACKAGE (unpackaged/buffer-provides)))" t)
...
(fn WHICH-TS FILE &optional SUBTREE-P)" t)
...
(fn FILE &key (DATE (calendar-current-date)) ENTRY)" t)
...
(fn &optional DEFAULT)" t)
(autoload 'unpackaged/org-sort-multi "unpackaged" "\
Call `org-sort' until \\[keyboard-quit] is pressed." t)
...
(fn &optional FEWER-LINES UNFILL)" t)
...
to choose a different correction." t)
...
command was called, go to its unstaged changes section." t)
(autoload 'unpackaged/magit-save-buffer-show-status "unpackaged" "\
Save buffer and show its changes in `magit-status'." t)
...
(fn URL &key (PREFER \\='atom) (ALL nil))" t)
(register-definition-prefixes "unpackaged" '("unpackaged/"))

;;; End of scraped data

(provide 'unpackaged-autoloads)
